...
Release 0.1.0a24 intentionally replaces the alpha command grammar. There are
...
| Before 0.1.0a24 | 0.1.0a24 and later |
|---|---|
...
1. Install and pin 0.1.0a24 or later in every TaskQ runtime consumer.
...
6. Upgrade to 0.1.0a25 and apply migration 0021 only after all consumers
   understand the dormant 0.3.1 models.
