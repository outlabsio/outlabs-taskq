...
**Durable admission is the C6 replacement prerequisite:** ADR-023 / Protocol 1.0.8 / SQL contract 0.1.5 generalize the QDarte replay gap into a queue-native reserve/finish/cancel primitive. S5-AR-01 implements the immutable SQL kernel and bridge proof; S5-AR-02 adds generated SQL/HTTP surfaces; S5-AR-AUDIT is the dual-PG acceptance boundary. Only its accepted release may be repinned into isolated QDarte C6 to prove replay without replanning. This sequence adds no permanent host ledger or wrapper, and authorizes no production migration, direct-queue retirement, or Stage-6 work.
