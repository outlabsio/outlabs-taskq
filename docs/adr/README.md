...
Candidate implementations (not yet released): [ADR-038](./ADR-038-terminal-host-effect-fence.md), transaction-bound terminal host-effect fence, SQL contract 0.6.9; [ADR-039](./ADR-039-queue-admission-owner.md), immutable queue admission owner, SQL contract 0.6.10.
