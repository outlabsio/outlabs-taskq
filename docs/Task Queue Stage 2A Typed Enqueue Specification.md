...
1. Process the review response. Any unresolved contract question stops implementation.
...
Each implementation task is a separate green commit with its validation result. No new SQL function is part of Stage 2A.
