...
[ADR-001..017](./adr/README.md). Accepted 2026-07-18 across the design reviews, contract adjudications, and the Stage-2/Stage-3 gates. Reopening one requires new evidence and a new ADR.
...
| [Host Branch Reconciliation Specification](./Task%20Queue%20Host%20Branch%20Reconciliation%20Specification.md) | Post-Stage-4 commit ledger, exact-tree reconciliation, authoritative branch cutover, rollback | Frozen implementation plan; no branch or deployment mutation until independent review |
| [Legacy Tools Path Retirement Specification](./Task%20Queue%20Legacy%20Tools%20Path%20Retirement%20Specification.md) | Tools-only fallback/consumer retirement, observation gate, zero-DML rollback | Frozen implementation plan; shared legacy table and non-tools lanes explicitly remain |
