...
[ADR-001..013](./adr/README.md). Accepted 2026-07-18 across the design reviews, round-3 contract adjudication, and the Stage-2 worker contract gate. Reopening one requires new evidence and a new ADR.
...
| [Review round 1](./design-review/README.md) / [round 2](./design-review-2/README.md) / round 3 [request](./design-review-3/REQUEST.md) + [response](./design-review-3/RESPONSE.md) | External reviews and requests, verbatim as received or sent; every accepted finding lives on in ADRs/contracts — read those, not these |
