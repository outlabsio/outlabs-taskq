...
| [Review round 1](./design-review/README.md) / [round 2](./design-review-2/README.md) / round 3 [request](./design-review-3/REQUEST.md) + [response](./design-review-3/RESPONSE.md) / round 4 [request](./design-review-4/REQUEST.md) + [response](./design-review-4/RESPONSE.md) / round 5 [request](./design-review-5/REQUEST.md) + [response](./design-review-5/RESPONSE.md) / round 6 [request](./design-review-6/REQUEST.md) | External reviews and requests, verbatim as received or sent; every accepted finding lives on in ADRs/contracts — read those, not these |
