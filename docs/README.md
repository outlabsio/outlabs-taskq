...
| [Stage 5 QDarte Contact Verify Compatibility and Cutover Specification](./Task%20Queue%20Stage%205%20QDarte%20Contact%20Verify%20Compatibility%20and%20Cutover%20Specification.md) | C6 local caller compatibility, one-publisher mode, direct-drain, and rollback evidence, followed by the separately gated C7 production-evidence sequence | C6-03B exact-hash pins accepted release a6 and proves created/existed replay without replanning in disposable local development; targeted acceptance now gates C6-04. No production action or retirement is authorized |
