...
| [Stage 5 QDarte Contact Verify Implementation Specification](./Task%20Queue%20Stage%205%20QDarte%20Contact%20Verify%20Implementation%20Specification.md) | CV-01..CV-05 local compatibility, stable-result, preflight, closed-worker canary, recovery, and rollback sequence | CV-01 is next; each later slice remains explicitly gated. No production, retirement, broad-worker, or non-contact change is authorized |
