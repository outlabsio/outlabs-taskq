...
- **Current compatibility successor:** `v0.1.0a20` updates only package identity and the optional
  OutLabs adapter dependency to the audited `outlabs-auth==0.1.0a27`; SQL, protocol, and migrations
  remain unchanged.
