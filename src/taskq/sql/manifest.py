"""Machine-readable PostgreSQL catalog manifest for SQL contract 0.6.2.
...
TABLE_SHAPES = {
    ...
    "queue_flow": (13, "874777e0e7dd5c27f79de1274f5a1e5d"),
...
CONSTRAINTS = {
    ...
    "queue_flow": (7, "a5bbea2e6d69c1bff2a53c237692f305"),
