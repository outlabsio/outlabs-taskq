...
ADMISSION_SQL_CONTRACT_VERSIONS = frozenset({"0.1.5", "0.2.0", "0.2.1", "0.2.2", "0.2.3"})
WORKFLOW_SQL_CONTRACT_VERSIONS = frozenset({"0.2.1", "0.2.2", "0.2.3"})
SCHEDULE_SQL_CONTRACT_VERSIONS = frozenset({"0.2.2", "0.2.3"})
