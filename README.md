...
**Status:** alpha — current package version **`0.1.0a18`** uses SQL contract **`0.2.6`**. The SQL kernel, typed client, worker and CLI, testing helpers, optional FastAPI facade, authorization boundary, durable admission, atomic follow-ups, workflows, schedules, projections, and worker presence are implemented.
...
```
src/taskq/
  sql/           # migrations 0001-0017, runner/verifier, manifest, SQL transport
