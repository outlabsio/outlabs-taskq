...
| Doc | What it is |
|---|---|
| [`docs/adr/`](docs/adr/README.md) | **Accepted decisions (ADR-001..022) — override conflicting passages elsewhere** |
