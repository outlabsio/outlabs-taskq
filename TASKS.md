...
| Next review | FR-02 must freeze the minimum native follow-up, dependency/workflow, schedule and operator-projection program from the closed FR-01 evidence. Contract-visible work remains docs-first and independently reviewable. No production deployment, old-ledger migration, or C8 observation work is part of the active goal |
...
- [ ] **S5-QD-FR-02 · Native 0.2 prerequisite program** — from FR-01 evidence, freeze and deliver lossless follow-ups, dependencies/workflows, schedules, and only the finite operator projections QDarte actually needs. One capability per docs-first contract/migration/client/parity/race/plan/artifact slice, bridge-first at every SQL revision; QDarte may not emulate a missing capability.
  ...
  - [ ] **FR-02A · Lossless native follow-ups** — freeze ADR/Protocol/Manifest identities and bridge support, then ship immutable migration 0008, typed child targets, runtime/client/fake support and complete atomicity/race/parity/artifact evidence.
