...
| Next review | Compose the private reporter into the local native runtime and prove one disposable SQL/HTTP contact effect end to end: authoritative attempt, bounded authenticated report, domain mutation plus receipt in one transaction, response-loss replay conservation and zero old-ledger/runtime use. CQ-11 remains isolated |
