...
- [ ] **S5-QD-REVIEW · QDarte pilot targeted review** — assemble and obtain independent review before P0–P5; it must rederive QDarte queue/worker/handler inventory, challenge a3 bridge, privileges, connection posture, handler purity, no-dual-publish and legacy-table isolation, and replay/hard-kill/rollback oracles. It may authorize isolated-dev only, never production, existing-lane migration, external side effect, or Stage 6.
