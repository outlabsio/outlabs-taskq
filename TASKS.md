...
| Next review | The QDarte-private native reporter transport is frozen docs-first: one bounded internal POST, shared QueueAuthorizer, authenticate + queue-run-authorize before decode, and reporter-owned attempt identity. Implement HTTP parity and disposable SQL contact proof; CQ-11 remains isolated |
