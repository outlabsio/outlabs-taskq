...
| Suite | 501/501 regular on fresh local PG18.3 with 1 opt-in skip (CI-shaped Redis); 489/489 last exact PG16.14 kernel run with 1 opt-in skip; 308/308 DB-free on Python 3.12; 289/289 last Python 3.13 run; PG18 million-row plan gate 2/2; artifact matrix 12/12 last completion audit; host 72/72 regular with 5 pre-existing opt-in skips; MyPy 64 files |
