...
| Next review | FR-02D-ACTIVATE is complete. Generated clients, the capability-gated facade, SQL/HTTP parity and authorization/cursor vectors are next; no production deployment, QDarte migration, old-ledger import or C8 observation has occurred |
