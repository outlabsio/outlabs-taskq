...
- [ ] **S5-QD-C7-R16-DELTA-REQUEST · Targeted environment-plan recheck** — pin the immutable Round-16 response and the R16-01..03 docs-only repair. Require exact valid cohort shape, private Compose reachability, worker network isolation, runtime-owned proxy verifier, readiness-bearing health, and scope. READY may open only C7-01 preflight.
